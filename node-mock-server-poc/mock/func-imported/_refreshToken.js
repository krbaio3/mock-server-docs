...
module.exports = {
	...
	imported_refreshToken: function (loopArr) {
        ...
        found1 = loopArr.indexOf('imported_refreshToken');

        if (found1 >= 0) {
        	if (loopArr.indexOf('imported_refreshToken', found1 + 1) >= 0) {
        		return '{}';
        	}
        }

        loopArr.push('imported_refreshToken');
